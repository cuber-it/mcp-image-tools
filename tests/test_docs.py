...
from mcp_image_tools.server.registry import catalogue

ROOT = Path(__file__).resolve().parents[1]
README = (ROOT / "README.md").read_text(encoding="utf-8")
DOC = ROOT / "doc"
REPOSITORY = "https://github.com/cuber-it/mcp-image-tools/blob/master/"
SOURCES = [
    ROOT / "src/mcp_image_tools/server/app.py",
    ROOT / "src/mcp_image_tools/server/auth.py",
]
